...
export type Settings = {
  ...
  contacts?: Array<{
    source?: "internal" | "contactForm" | "business" | "team";
    title?: string;
    firstName?: string;
    lastName?: string;
    contactEmail?: string;
...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | Category | BlockContent | Settings | Contact | Country | Post | Author | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | Slug;
